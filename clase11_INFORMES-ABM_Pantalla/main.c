...
int main()
{
    ...
    strcpy(visores[1].direccion, "Belgrano 1150");
    visores[1].isEmpty=0;
    ...
    strcpy(visores[2].direccion, "Maipu 1150");
    visores[2].isEmpty=0;
    ...
    while(opcion!=7)
    {
        ...
        switch(opcion)
        {
            ...
            case 6:
            {
                pan_ordenarPorPrecio(visores, LEN_LISTA);
                break;
            }
            case 8:
            {
                pub_ordenarDiasMenorDiez(Marketing, visores, LEN_LISTA);
                break;
            }
        }
    }
