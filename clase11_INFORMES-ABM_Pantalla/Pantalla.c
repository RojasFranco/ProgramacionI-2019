...
int pan_ordenarPorPrecio(Pantalla* pPantalla, int len)
{
    int i;
    int flag;
    Pantalla auxiliar;
    do
    {
        ...
        for(i=0;i<len-1;i++)
        {
            ...
            {
                auxiliar=pPantalla[i];
                pPantalla[i]=pPantalla[i+1];
                pPantalla[i+1]=auxiliar;
                flag=1;
            }
            else if(pPantalla[i].precio==pPantalla[i+1].precio)
            {
                if(strncasecmp(pPantalla[i].nombre,pPantalla[i+1].nombre, 50)>0)
                {
                    auxiliar=pPantalla[i];
                    pPantalla[i]=pPantalla[i+1];
                    pPantalla[i+1]=auxiliar;
...
int pan_getByID(Pantalla* pPantalla, int len, int id)
{
    int i;
    int retorno=-1;
    for(i=0;i<len;i++)
